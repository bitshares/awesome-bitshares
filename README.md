...
### Opensource Wallets and Apps

* [BTS++](http://btspp.io/) - native Android/iOS app
* [BiTSy](http://www.BiTSy-wallet.com) - Android mobile wallet with merchant/tellers map
* [PalmPay](https://palmpay.io) - Android Point Of Sale system
* [Beet](https://github.com/bitshares/beet/) - Standalone key/ID-manager & signing app (Win/Mac/Liux)
...
* [graphenej](https://github.com/Agorise/graphenej) - used by mobile app Developers
...
* [PalmPay](https://PalmPay.io) - Chain-agnostic Point Of Sale system, based on Bitshares
